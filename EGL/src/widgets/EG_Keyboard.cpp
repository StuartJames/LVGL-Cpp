...
#define EG_KB_BTN(width) EG_BTNMATRIX_CTRL_POPOVER | width
...
static const EG_ButMatrixCtrl_t default_kb_ctrl_lc_map[] = {
	EG_KEYBOARD_CTRL_BTN_FLAGS | 5, EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_KB_BTN(4), EG_BTNMATRIX_CTRL_CHECKED | 7,
	EG_KEYBOARD_CTRL_BTN_FLAGS | 6, EG_KB_BTN(3), EG_KB_BTN(3), EG_KB_BTN(3), EG_KB_BTN(3), EG_KB_BTN(3), EG_KB_BTN(3), EG_KB_BTN(3), EG_KB_BTN(3), EG_KB_BTN(3), EG_BTNMATRIX_CTRL_CHECKED | 7,
	EG_BTNMATRIX_CTRL_CHECKED | EG_KB_BTN(1), EG_BTNMATRIX_CTRL_CHECKED | EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_BTNMATRIX_CTRL_CHECKED | EG_KB_BTN(1), EG_BTNMATRIX_CTRL_CHECKED | EG_KB_BTN(1), EG_BTNMATRIX_CTRL_CHECKED | EG_KB_BTN(1),
...
static const EG_ButMatrixCtrl_t default_kb_ctrl_spec_map[] = {
	EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_BTNMATRIX_CTRL_CHECKED | 2,
	EG_KEYBOARD_CTRL_BTN_FLAGS | 2, EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1),
	EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1), EG_KB_BTN(1),
	EG_KEYBOARD_CTRL_BTN_FLAGS | 2, EG_BTNMATRIX_CTRL_CHECKED | 2, 6, EG_BTNMATRIX_CTRL_CHECKED | 2, EG_KEYBOARD_CTRL_BTN_FLAGS | 2};
