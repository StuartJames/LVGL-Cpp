...
void EGSoftContext::BufferCopy(void *pDestBuffer, int32_t DestInc, EGRect *pDestRect, void *pSourceBuffer, int32_t SourceInc, EGRect *pSourceRect)
{
	...
	for(int32_t y = pDestRect->GetY1(); y <= pDestRect->GetY2(); y++) {
