...
enum EGStyleProperty_e{
  ...
  EG_STYLE_POLY_WIDTH             = 62,
  EG_STYLE_POLY_COLOR             = 63,
  EG_STYLE_POLY_OPA               = 64,
  EG_STYLE_POLY_FILL_COLOR        = 65,
  EG_STYLE_POLY_FILL_OPA          = 66,
  EG_STYLE_TEXT_COLOR             = 67,
  EG_STYLE_TEXT_OPA               = 68,
  EG_STYLE_TEXT_FONT              = 69,
  EG_STYLE_TEXT_LETTER_SPACE      = 70,
  EG_STYLE_TEXT_LINE_SPACE        = 71,
  EG_STYLE_TEXT_DECOR             = 72,
  EG_STYLE_TEXT_ALIGN             = 73,

  // Group 6
  EG_STYLE_OPA                    = 74,
  EG_STYLE_OPA_LAYERED            = 75,
  EG_STYLE_COLOR_FILTER_DSC       = 76,
  EG_STYLE_COLOR_FILTER_OPA       = 77,
  EG_STYLE_ANIM                   = 78,
  EG_STYLE_ANIM_TIME              = 79,
  EG_STYLE_ANIM_SPEED             = 80,
  EG_STYLE_TRANSITION             = 81,
  EG_STYLE_BLEND_MODE             = 82,
  EG_STYLE_TRANSFORM_WIDTH        = 83,
  EG_STYLE_TRANSFORM_HEIGHT       = 84,
  EG_STYLE_TRANSLATE_X            = 85,
  EG_STYLE_TRANSLATE_Y            = 86,
  EG_STYLE_TRANSFORM_ZOOM         = 87,
  EG_STYLE_TRANSFORM_ANGLE        = 88,
  EG_STYLE_TRANSFORM_PIVOT_X      = 89,
  EG_STYLE_TRANSFORM_PIVOT_Y      = 90,

  _EG_STYLE_LAST_BUILT_IN_PROP    = 90,
