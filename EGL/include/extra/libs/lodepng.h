...
The out buffer must have size (w * h * BitsPerPixel + 7) / 8, where BitsPerPixel is the bits per pixel
of the output color type (lodepng_get_bpp).
For < 8 BitsPerPixel images, there should not be padding bits at the end of scanlines.
