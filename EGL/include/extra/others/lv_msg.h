 ...
 * `EG_EVENT_MSG_RECEIVED` will be triggered if a message with matching ID was sent
 * @param msg_id        the message ID to listen to
...
/**
 * Get the message object from an event object. Can be used in `EG_EVENT_MSG_RECEIVED` events.
...
static inline void * lv_msg_subscribe_obj(uint32_t msg_id, EGObject * obj, void * user_data)
{
    return lv_msg_subsribe_obj(msg_id, obj, user_data);
}

extern lv_event_code_t EG_EVENT_MSG_RECEIVED;
