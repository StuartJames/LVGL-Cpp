...
struct _lv_fragment_class_t {
     ...
     */
    EGObject * (*create_obj_cb)(lv_fragment_t * self, EGObject * container);
     ...
     */
    void (*obj_created_cb)(lv_fragment_t * self, EGObject * obj);
     ...
     */
    void (*obj_will_delete_cb)(lv_fragment_t * self, EGObject * obj);

    /**
     * Called when the object created by fragment received `EG_EVENT_DELETE` event
     * @param self Fragment instance
     * @param obj object with this fragment
     */
    void (*obj_deleted_cb)(lv_fragment_t * self, EGObject * obj);
