...
//  Chart update mode for `EG_Chart.SetNext`
enum {
...
public:
  ...
  void              SetAxisRange(EG_ChartAxis_e Axis, int32_t Min, int32_t Max);
  void              SetAxisMinValue(EG_ChartAxis_e Axis, int32_t Min);
  void              SetAxisMaxValue(EG_ChartAxis_e Axis, int32_t Max);
  ...
  void              SetAxisTick(EG_ChartAxis_e Axis, int32_t MajorLength, int32_t MinorLength,
  ...
  void              SetAllValue(EG_CharSeries_t *pSeries, int32_t Value);
  void              SetNextValue(EG_CharSeries_t *pSeries, int32_t Value);
  void              SetNextValues(EG_CharSeries_t *pSeries, int32_t ValueX, int32_t ValueY);
  void              SetValueByIndex(EG_CharSeries_t *pSeries, uint16_t Index, int32_t Value);
  void              SetValuesByIndex(EG_CharSeries_t *pSeries, uint16_t Index, int32_t ValueX, int32_t ValueY);
  void              SetExtArrayY(EG_CharSeries_t *pSeries, int32_t Array[]);
  void              SetExtArrayX(EG_CharSeries_t *pSeries, int32_t Array[]);
  int32_t*          GetArrayY(EG_CharSeries_t *pSeries);
  int32_t*          GetArrayX(EG_CharSeries_t *pSeries);
...
private:
  void              DrawDivisionLines(EGDeviceContext *pDC);
  void              DrawLineSeries(EGDeviceContext *pDC);
  void              DrawScatterSeries(EGDeviceContext *pDC);
  void              DrawBarSeries(EGDeviceContext *pDC);
  void              DrawCursors(EGDeviceContext *pDC);
  void              DrawAxisY(EGDeviceContext *pDC, EG_ChartAxis_e Axis);
  void              DrawAxisX(EGDeviceContext *pDC, EG_ChartAxis_e Axis);
  void              DrawAxis(EGDeviceContext *pDC);
  uint32_t          GetIndexFromX(int32_t X);
  void              InvalidatePoint(uint16_t Index);
  void              AllocateNewPoints(EG_CharSeries_t *pSeries, uint32_t Count, int32_t **pPoints);
