...
public:
  ...
  void              SetBuffer(void *pBuffer, int32_t Width, int32_t Height, EG_ImageColorFormat_t ColorFormat);
  void              SetPixelColor(int32_t X, int32_t Y, EG_Color_t Color);
  void              SetPixel(int32_t X, int32_t Y, EG_Color_t Color);
  void              SetPixelOPA(int32_t X, int32_t Y, EG_OPA_t OPA);
  void              SetPalette(uint8_t id, EG_Color_t Color);
  EG_Color_t        GetPixel(int32_t X, int32_t Y);
  EGImageBuffer*    GetImage(void);
  void              CopyBuffer(const void *pDest, int32_t X, int32_t Y, int32_t Width, int32_t Height);
  void              Transform(EGImageBuffer *pImage, int16_t Angle, uint16_t Zoom, int32_t OffsetX, int32_t OffsetY, 
  ...
  void              DrawRect(int32_t X, int32_t Y, int32_t w, int32_t h, EGDrawRect *pDrawRect);
  void              DrawText(int32_t X, int32_t Y, int32_t max_w, EGDrawLabel * pDrawLabel, const char *pText);
  void              DrawImage(int32_t X, int32_t Y, const void *pSource, EGDrawImage * pDrawImage);
  ...
  void              DrawArc(int32_t X, int32_t Y, int32_t Radius, int32_t StartAngle, int32_t EndAngle, EGDrawArc *pDrawArc);
...
inline void EGCanvas::SetPixel(int32_t X, int32_t Y, EG_Color_t Color)
{
