...
#error "EGButton is required. Enable it in EG_Config.h (EG_USE_BTNMATRIX  1) "
#endif

#if EG_USE_TEXTAREA == 0
#error "EGEdit is required. Enable it in EG_Config.h (EG_USE_TEXTAREA  1) "
#endif
