...
#error "EGTable: EGLabel is required. Enable it in EG_Config.h (EG_USE_LABEL 1)"
#endif
...
public:
  ...
  void                SetColumnWidth( uint16_t ColumnIndex, int32_t Width);
  ...
  int32_t          GetColumnWidth(uint16_t Column);
  ...
  int32_t         *m_pRowHeight;
  int32_t         *m_pColumnWidth;
...
private:
  ...
  int32_t          GetRowHeight(uint16_t RowIndex, const EG_Font_t *pFont, int32_t Kerning, int32_t LineSpace,
