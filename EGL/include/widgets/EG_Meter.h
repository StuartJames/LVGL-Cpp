...
#error "Complex drawing is required. Enable it in EG_Config.h (EG_DRAW_COMPLEX 1)"
#endif

///////////////////////////////////////////////////////////////////////////////////////

enum EG_IndicatorType_e{
...
public:
  ...
  EG_Indicator_t*   AddNeedleImage(EG_MeterScale_t *pScale, const void *pSource, int32_t PivotX, int32_t PivotY);
...
private:
  void              DrawArcs(EGDeviceContext *pDC, const EGRect *pScaleArea);
  void              DrawTicksLabels(EGDeviceContext *pDC, const EGRect *pScaleArea);
  void              DrawNeedles(EGDeviceContext *pDC, const EGRect *pScaleArea);
